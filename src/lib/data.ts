...
export const testimonials = [
  { title: "適合對象", items: ["有穩定收入的上班族", "自由業 / 小生意經營者", "信用卡或貸款正常繳款者", "有資金週轉需求者"] },
  { title: "基本條件", items: ["年滿 20 歲本國國民", "有固定收入來源", "具備基本還款能力", "提供身分證明文件"] },
  { title: "準備文件", items: ["身分證正反面影本", "第二證件影本", "財力證明文件", "薪轉 / 扣繳憑單等資料"] },
  { title: "加分條件", items: ["信用卡往來良好", "有固定薪轉紀錄", "現有貸款繳款正常", "名下有房產或車輛"] },
];
